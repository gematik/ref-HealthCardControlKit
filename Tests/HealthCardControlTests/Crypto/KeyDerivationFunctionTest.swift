...
final class KeyDerivationFunctionTest: XCTestCase {
    ...
    func testAes128KeyDerivation() {
        let sharedSecret = Data(bytes: [0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38]) // =Data("12345678".utf8)
        let expected = Data(bytes: [0x66, 0x3E, 0xAB, 0xAB, 0xA9, 0x9E, 0x95, 0x4E, 0x8D, 0x22, 0x88, 0x95, 0x40,
                                    0xED, 0xC6, 0x6C])
