...
final class AESTests: XCTestCase {
    ...
    func testAes128Decipher() {
        let encKey = Data(bytes: [0x66, 0x3E, 0xAB, 0xAB, 0xA9, 0x9E, 0x95, 0x4E, 0x8D, 0x22, 0x88, 0x95, 0x40, 0xED,
                                  0xC6, 0x6C])
        let nonceZ = Data(bytes: [0x5B, 0x46, 0x16, 0x16, 0x5A, 0x08, 0xE7, 0xD9, 0x01, 0x6B, 0x0B, 0xE1, 0xCE, 0xB5,
                                  0x3F, 0x9E])
        let expected = Data(bytes: [0x9F, 0xFB, 0x42, 0xA2, 0x24, 0x68, 0x0F, 0x72, 0x1A, 0x3A, 0xDE, 0x59, 0x93, 0xC0,
                                    0xFD, 0x11])
    ...
    func testAes128Encipher() {
        let encKey = Data(bytes: [0x66, 0x3E, 0xAB, 0xAB, 0xA9, 0x9E, 0x95, 0x4E, 0x8D, 0x22, 0x88, 0x95, 0x40, 0xED,
                                  0xC6, 0x6C])
        let expected = Data(bytes: [0x5B, 0x46, 0x16, 0x16, 0x5A, 0x08, 0xE7, 0xD9, 0x01, 0x6B, 0x0B, 0xE1, 0xCE, 0xB5,
                                  0x3F, 0x9E])
        let nonceS = Data(bytes: [0x9F, 0xFB, 0x42, 0xA2, 0x24, 0x68, 0x0F, 0x72, 0x1A, 0x3A, 0xDE, 0x59, 0x93, 0xC0,
                                    0xFD, 0x11])
    ...
    func testAes128Encipher2() {
        let encKey = Data(bytes: [0x66, 0x3E, 0xAB, 0xAB, 0xA9, 0x9E, 0x95, 0x4E,
